...
export const Worksbox = (props: Works) => {
    return (
        <article className="border border-border/80 bg-black/15 px-6 py-6 md:px-7 md:py-7 transition-colors duration-300 hover:border-green-mid/40">

        ...
        <>
            <section className="ml-3 mr-3 lg:mx-32 2xl:mx-80 md:mx-20 md:mt-32 mt-6">
                <div className="grid md:grid-cols-2 gap-8 items-start">
                    {/* Left side - Hero text */}
                    <section>
                        <div className="mt-12 mb-6 flex w-max items-center gap-2 rounded-full border border-green-900/40 bg-green-light px-3 py-1.5 text-xs text-green-mid">
                            <span className="w-2 h-2 bg-green-600 rounded-full"></span>
                            Now in public beta
                        </div>

                        <h1 className="text-3xl font-bold text-text md:text-4xl">Turn customer <br className="hidden md:block" /> feedback into <br className="hidden md:block" /> product decisions <br className="hidden md:block" /> automatically.</h1>
                        <p className="mt-4 mb-2 text-muted">Nevo collects feedback from every channel, finds the <br className="hidden md:block" /> patterns, and tells your team exactly what to build next. <br className="hidden md:block" /> No spreadsheets. No guesswork.</p>
                        ...
                        <div className="flex items-center gap-2 mt-6 mb-6">
                            ...
                            <span className="text-xs text-muted">Joined by 2,400+ product teams this month</span>
                        </div>
                    </section>
                    ...
                    <aside className="md:block md:mt-16">
                        <article className="rounded-2xl border border-border/85 bg-surface p-6 shadow-[0_18px_45px_rgba(0,0,0,0.38)]">
                            <h3 className="mb-5 text-sm font-semibold text-text">Recent feedback</h3>
                            ...
                            <ul className="space-y-3 mb-3">
                                <li className="flex gap-2.5 border-b border-border py-3 first:pt-0 last:border-b-0">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="mb-1 text-xs font-medium text-muted">Alex M. · Intercom · 2 min ago</div>
                                ...
                                <li className="flex gap-2.5 border-b border-border py-3 first:pt-0 last:border-b-0">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="mb-1 text-xs font-medium text-muted">Sara R. · Zendesk · 8 min ago</div>
                            ...
                            <div className="rounded-lg border border-slate-700/80 bg-black/85 p-5 text-white">
                                <h4 className="mb-2 text-xs font-semibold uppercase tracking-wider text-muted">💡 NEVO INSIGHT</h4>
                                ...
                                <div className="flex items-center justify-between">
                                    <span className="rounded-full border border-slate-700 bg-slate-900 px-2.5 py-1 text-xs text-slate-300">3 mentions · High priority</span>
             ...
             <div className="mt-12 w-screen items-center justify-center border border-border/90 bg-surface/35 p-4 px-36">

                <div className=" text-center justify-center text-xs md:justify-start flex items-center md:px-23 lg:px-32 gap-6">

                <h3 className="text-muted">USED BY</h3>
                <span className=" text-muted">|</span>
                <span className=" text-muted">STRIPE</span>
                <span className=" text-muted">LOOM</span>
                <span className=" text-muted">NOTION</span>
                <span className=" text-muted">VERCEL</span>
                </div>

            </div>

            <section className="mx-3 mt-12 mb-12 md:mx-20 lg:mx-32 2xl:mx-80">
                <h1 className="text-2xl font-bold text-text"> From raw feedback to clear action in three steps.</h1>
                <p className="text-muted mt-3">Nevo connects to the tools you already use, reads every message, and surfaces the signal from the noise, so your PM never misses what customers are asking for.</p>
